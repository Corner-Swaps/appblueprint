  ...
  return (
    ...
    >
      <g fill={color} transform={expanded15 ? "matrix(1.15 0 0 1.15 -76.875 -75.15)" : undefined}>
        ...
        <path d="M 825 166 L 827 185 L 819 228 L 808 268 L 792 309 L 760 367 L 738 398 L 705 437 L 664 478 L 610 522 L 598 513 L 592 506 L 612 482 L 632 450 L 645 421 L 650 406 L 654 385 L 629 397 L 597 420 L 575 441 L 550 472 L 533 458 L 561 404 L 593 353 L 620 317 L 652 281 L 688 248 L 719 225 L 769 196 L 812 178 L 825 166 Z" />
        {/* Left Delta Fin */}
