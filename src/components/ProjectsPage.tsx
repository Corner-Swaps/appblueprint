...
export const ProjectsPage: React.FC<ProjectsPageProps> = ({
  ...
  return (
    <div className="space-y-3.5 pb-4">
      ...
      {/* 2. List of Projects (Exact same card proportions, squircle, and title typography as Phase cards) */}
      <div className="space-y-4 pt-1">
        
        {/* + Project Card: Same pill size as the other project cards */}
        {!isAddingProject ? (
          <div
            onClick={() => {
              if (editingProjectId) {
          ...
          >
            ...
            {/* Empty placeholder bar matching the Toggle bar height so card size is identical */}
          ...
          >
            <div className="flex items-center justify-between gap-3 select-none">
              <div className="flex items-center space-x-3.5 select-none flex-1 min-w-0">
                {/* Squircle with project color and bio folder icon */}
                <div 
                ...
                {/* Name right next to the folder icon */}
            ...
            {/* Colours in place of the Toggle bar (progress bar) */}
        ...
        {projects.map((proj, projIdx) => {
          ...
          const projColor = getProjectColor(proj, projIdx);
          ...
          return (
            <div
              ...
              className={`rounded-3xl border bg-white p-5 sm:p-6 transition-colors duration-150 shadow-xs space-y-4 select-none cursor-pointer ${
                isActive 
                  ? 'border-2' 
            ...
            >
              <div className="flex items-start justify-between gap-3 select-none">
                ...
                {/* Left: Squircle Icon & Project Title */}
                  ...
                  <div className="space-y-1 select-none flex-1 min-w-0 min-h-[48px] flex flex-col justify-center">
                    ...
                    {isEditingThisProj ? (
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <h2 className="text-base sm:text-lg font-black text-slate-900 tracking-tight leading-snug select-none font-google truncate flex-1 min-w-0">
                          {proj.name}
                        </h2>

                        {/* Pencil (left) and Trashcan (right) on the exact same line as the title */}
                        <div className="flex items-center space-x-1 shrink-0 -my-1">
                          {/* Rename Button (Pencil on the left) */}
                          <button
                            type="button"
                            onClick={(e) => {
                              e.stopPropagation();
                          ...
                          {/* Delete Button (Trashcan on the right, if more than 1 project) */}
                          {projects.length > 1 && (
                            <button
                              type="button"
                              onClick={(e) => {
              ...
              {/* Progress Bar (Matching project color and Phase card bar) */}
