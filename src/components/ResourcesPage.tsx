...
const SECTION_CONFIGS: SectionConfig[] = [
  {
    ...
    badge: 'AI Models',
    description: 'Explore premier frontier reasoning models and autonomous coding assistants for your project. These tools inspect your codebase, write complete components, and resolve errors automatically. Choose the model that best matches your workflow to accelerate your mobile development.',
  ...
  },
  {
    ...
    badge: 'Design & UX',
    description: 'Create beautiful, comfortable mobile interfaces that follow official Apple and Google design guidelines. Learn proven mobile layout rules, thumb-friendly touch targets, and authentic Apple Liquid Glass depth. These resources help you benchmark top designs while keeping your artwork 100% original.',
    iconBg: 'bg-rose-500',
  ...
  },
  {
    ...
    badge: 'Typography',
    description: 'Explore world-class open typefaces and free commercial font collections. Learn how to self-host fonts locally inside your app package to eliminate third-party server tracking and satisfy GDPR privacy rules. Good typography makes your text effortless to read across all screen sizes.',
  ...
  },
  {
    ...
    badge: 'Open Source',
    description: 'Access battle-tested open-source libraries and mobile software kits built by the community. Integrate ready-made tools for in-app purchases, camera controls, native tactile haptics, and automated testing. Save hundreds of development hours by utilizing reliable open-source frameworks.',
    iconBg: 'bg-blue-600',
    icon: (
  ...
  },
  {
    ...
    badge: 'Cloud & DB',
    description: 'Set up your database, user authentication, and cloud infrastructure with generous free tiers. Store user profiles securely, trigger serverless functions, and sync data in real time. These platforms let you scale from your first prototype to millions of active users.',
    iconBg: 'bg-teal-600',
  ...
  },
  {
    ...
    badge: 'Security',
    description: 'Protect user passwords, secret keys, and personal information using hardware encryption. Use the iOS Keychain and Android Keystore to keep sensitive data safe from unauthorized access. These guides help you pass strict store security audits on your first attempt.',
  ...
  },
  {
    ...
    badge: 'Privacy',
    description: 'Generate required privacy manifests and complete store safety questionnaires truthfully. Apple and Google strictly inspect data collection, tracking identifiers, and consent notices. These resources ensure your app fully respects user privacy and satisfies global data laws.',
    iconBg: 'bg-indigo-600',
  ...
  },
  {
    ...
    badge: 'Legal',
    description: 'Create plain-English Privacy Policies, Terms of Service, and EULA agreements for your app. Host your legal and contact pages for free using GitHub Pages so reviewers can access them. Follow these templates to protect your project and meet all store publishing rules.',
    iconBg: 'bg-amber-600',
  ...
  },
  {
    ...
    badge: 'Launch & ASO',
    description: 'Prepare your store listing with high-converting screenshots, clear titles, and effective search keywords. Avoid common rejection traps like misleading descriptions, price claims, or broken reviewer logins. These tools guide you through every step of publishing to Apple and Google Play.',
    iconBg: 'bg-cyan-600',
  ...
  },
  {
    ...
    badge: 'Observability',
    description: 'Monitor app performance and track crashes in real time so you can fix bugs before users complain. View clear crash logs without compromising user privacy or violating data tracking regulations. Keep your app stable and maintain high store ratings with proactive monitoring.',
...
export const ResourcesPage: React.FC<ResourcesPageProps> = ({ onBackToChecklist }) => {
  ...
  // Listen for collapse signal when switching tabs
  useEffect(() => {
    const handleCollapseSubs = () => {
      setExpandedItemId(null);
    };
    window.addEventListener('collapse-subsections', handleCollapseSubs);
    return () => window.removeEventListener('collapse-subsections', handleCollapseSubs);
  }, []);
  ...
  const renderBrandLogo = (item: ResourceItem) => {
    // 1. Anthropic / Claude (Official Terracotta/Coral Sunburst)
    ...
    // 2. OpenAI (Official Green Spiral Rosette)
    ...
    // 3. Google Gemini (Official 4-Color Sparkle)
    ...
    // 4. DeepSeek (Official Blue Whale)
    ...
    // 5. Figma (Official 5-Bubble Multicolored Vector)
    ...
    // 6. Apple (Authentic Solid Black Apple Silhouette)
    if (item.id.includes('apple') || item.id.includes('att') || item.id.includes('testflight') || item.id.includes('sf-pro')) {
      return (
    ...
    // 7. Google Play & Material (Official 4-Color Google Play Triangle)
    ...
    // 8. Supabase (Official Emerald Green Flash)
    ...
    // 9. Cloudflare (Official Vibrant Orange)
    ...
    // 10. Firebase (Official Amber/Orange Flame)
    ...
    // 11. Sentry (Official Violet & Ruby)
    ...
    // 12. PostHog (Official Golden Amber Hedgehog)
    ...
    // 13. RevenueCat (Official Coral Cat)
    ...
    // 14. Capacitor (Electric Cyan Chevron)
    ...
    // 16. GitHub (Official Dark Charcoal Octocat)
    ...
    // 17. Fontshare (Indian Type Foundry Purple)
    ...
    // 19. Geist / Vercel (Crisp Black Triangle)
    ...
    // Default Fallback Icons with Semantic Brand Colors
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* Drop-Down Arrow: Centered directly BELOW Section Description with light gray circle when pointing down, no circle when pointing up */}
                    ...
                    >
                      <ChevronDown 
                        ...
                        className={`w-4 h-4 stroke-[2.5] transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${
                          isSectionOpen ? 'rotate-180 text-slate-600' : 'text-slate-500'
                        }`}
                      />
                    </button>
                  </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                              ...
                              <div className="flex items-center space-x-3.5 pr-2 select-none flex-1 min-w-0">
                                ...
                                <div className="space-y-0.5 select-none flex-1 min-w-0">
                                  <div className="flex items-center gap-1.5 flex-wrap select-none">
                                    <span className="h-[18px] px-2 rounded-full text-[10px] font-bold uppercase tracking-wider bg-slate-100 text-slate-600 border border-slate-200/80 shadow-2xs select-none shrink-0 inline-flex items-center justify-center pt-[1px] leading-none">
                                      TOOL {itemIdx + 1}
                                    </span>
                                  </div>

                                  {/* Title with authentic Apple or Google Play typography where applicable */}
                                  <h3 
                            ...
                            {/* Centered arrow to pop down subsections drawer with subtle gray circle when closed */}
                            <div className="flex justify-center -mt-0.5 pb-0 select-none">
                              <button
                                type="button"
                                onClick={(e) => {
                                ...
                                className={`apple-press transition-colors ${
                                  !isItemOpen 
                                    ? 'w-6 h-6 rounded-full bg-slate-100 hover:bg-slate-200/80 flex items-center justify-center text-slate-500' 
                                    : 'p-0 text-slate-400 hover:text-slate-600'
                                }`}
                              ...
                              >
                                <ChevronDown 
                                  ...
                                  className={`w-3.5 h-3.5 stroke-[2.5] transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${
                                    isItemOpen ? 'rotate-180 text-slate-600' : 'text-slate-500'
                                  }`} 
                                />
                              </button>
                            </div>
                              ...
                              >
                                ...
                                {item.whyItMatters && (
                                  <div 
                                    ...
                                    className="space-y-1.5 cursor-auto"
                                  >
                                ...
                                {item.keyFeatures && item.keyFeatures.length > 0 && (
                                  <div 
                                    onClick={(e) => e.stopPropagation()}
                                    className="space-y-2 pt-1 border-t border-slate-100/80 cursor-auto"
                                  >
                                    <span className="font-bold text-slate-900 uppercase text-[11px] tracking-wider block font-google">
                                      Key Highlights
                                    </span>
                                ...
                                {item.bestUsedFor && (
                                  <div 
                                    onClick={(e) => e.stopPropagation()}
                                    className="space-y-1.5 pt-1 border-t border-slate-100/80 cursor-auto"
                                  >
                                    <span className="font-bold text-slate-900 uppercase text-[11px] tracking-wider block font-google">
                                      Best Used For
                                    </span>
                                ...
                                {/* Optional AI Prompt Example for Typography or Tools */}
                                {item.promptOrCommand && (
                                  <div 
                                    onClick={(e) => e.stopPropagation()}
                                    className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2 cursor-auto select-text"
                                  >
                                    <div className="flex items-center justify-between">
                                      <span className="font-bold text-slate-900 uppercase text-[11px] tracking-wider block font-google">
                                        {item.promptLabel || 'AI Agent Example Prompt'}
                                      </span>
                                    </div>
                                    <p className="text-slate-700 font-mono text-[12px] leading-relaxed whitespace-pre-line">
                                      {item.promptOrCommand}
                                    </p>
                                  </div>
                                )}
