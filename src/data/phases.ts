...
export const PHASES_DATA: Phase[] = [
  {
    "id": "phase-1",
    "number": 1,
    "title": "Idea, Audience & Scope Pruning",
  ...
  },
  {
    "id": "phase-2-layout",
    "number": 2,
    "title": "Screen Layout, Information Architecture & Wireframing",
    ...
    "items": [
      {
        ...
        "title": "Map Your Screen Inventory & Primary User Flows (User Route Architecture)",
      ...
      },
      {
        ...
        "phaseId": "phase-2-layout",
        "title": "Standard Mobile Screen Anatomy (Header, Scrollable Body & Dock)",
      ...
      },
      {
        "id": "p2-spatial-grid",
        "phaseId": "phase-2-layout",
        "title": "Mobile 8pt Spatial Grid & Card Hierarchy (Margins & Gutters)",
      ...
      },
      {
        "id": "p2-nav-hierarchy",
        "phaseId": "phase-2-layout",
        "title": "Mobile Navigation Hierarchy (Bottom Tabs vs Push Stacks vs Bottom Sheets)",
      ...
      },
      {
        "id": "p2-thumb-reach",
        "phaseId": "phase-2-layout",
        "title": "One-Handed Thumb Reach Zone & Information Density",
      ...
      },
      {
        "id": "p2-form-layout",
        "phaseId": "phase-2-layout",
        "title": "Card-Based Form Layout & Field Grouping",
  ...
  },
  {
    "id": "phase-2",
    "number": 3,
    "title": "Visual Design System, Components & Touch Targets",
  ...
  },
  {
    "id": "phase-data",
    "number": 4,
    "title": "Data Architecture, Schemas & Local State Modeling",
    ...
    "items": [
      {
        "id": "p4-schema-models",
        "phaseId": "phase-data",
        "title": "Define Strict TypeScript Data Models & Validation Schemas",
      ...
      },
      {
        ...
        "phaseId": "phase-data",
        "title": "Local-First Persistence & Resilient Auto-Save Mechanics",
      ...
      },
      {
        ...
        "phaseId": "phase-data",
        "title": "App Lifecycle & State Restoration After Background Suspension",
      ...
      },
      {
        ...
        "phaseId": "phase-data",
        "title": "Schema Versioning & Safe Data Migration Strategy",
  ...
  },
  {
    "id": "phase-3",
    "number": 5,
    "title": "Mobile Performance & Data Safety",
